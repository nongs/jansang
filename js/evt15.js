...
//랜덤한 문자를 리턴하는 함수
var letters = ["얼마나 무식하면 쯧쯧", "가면갈수록 별로다 걸레같아", "개 똥통 철학 지껄이지 말고 책이이나 좀 읽어라", "성적 취향 인증? 범죄아냐?", "아몰랑 유행이냐? 입쳐닫고있네", "어떤 정신 상태면 이럴수가 있는지 진짜 심각하다", "별게다 섹시하다 변태녀낰ㅋ", "개쓰레기년. 지 본색을 사정없이 들어내 버리네", "걍 접어라 노래도 네 얼굴도 안 듣고 안 보고 싶다", "연관검색어 '영악' 졸지에 이미지 메이킹 제대로햇네ㅋ", "잘가라 미친년아"];
